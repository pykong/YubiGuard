...
class YubiLock:
    def __init__(self):
        ...
        cs_proc.daemon = False  # must be false, or main program will terminate before YubiKeys can be unlocked
    ...
    def change_state(self):
        ...
        while True:
            ...
            cs_signal = ''  # reset state to prevent continuuos unlocking/locking
            time.sleep(.001)
